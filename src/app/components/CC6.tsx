...
const [postBookingStage, setPostBookingStage] = useState<
  null | "ASK_AGAIN" | "THANK_YOU"
>(null);
 ...
 const pushUserMessage = (text: string, stepIndexOverride?: number) => {
  setMessages((p) => [
    ...p,
    {
      ...
      from: "user",
      text,
      stepIndex: stepIndexOverride ?? currentStepIndex,
      time: time(),
    },
  ]);
...
if (postBookingStage === "ASK_AGAIN") {
  pushUserMessage(opt.label, 9999); // 👈 ADD stepIndex
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Image source={require('../../../assets/user.png')} style={{ width: scale(30), height: scale(30) }} resizeMode="center" />
                    </View>
                    <Text

...
const STATUS_TABS = [
  { label: "Active", value: "all", color: "#194594" },
              ...
              <TouchableOpacity
                ...
                style={[
                  styles.tabButton,
                  {
                    ...
                    backgroundColor: isActive ? "#F2DDC5" : "#ffffff00",
                    borderRightWidth:
        ...
        >
          ...
          >
            ...
            {item.status == "completed" && (
              <TouchableOpacity onPress={() => setReviewVisible(true)}>
                <Text style={{ color: "#027CC7" }}>Write a Review</Text>
              </TouchableOpacity>
            )}
          </View>
          ...
          <View style={styles.progressContainer}>
            ...
            <View style={styles.verifyRow}>
              ...
              {isOnHold && (
                <Text style={{ color: "red", marginRight: scale(20) }}>
                  On Hold
                </Text>
              )}
            </View>

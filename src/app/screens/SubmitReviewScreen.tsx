    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.providerName}>CoolHome{"\n"}Services</Text>

            <View style={styles.locationRow}>
              <Ionicons name="location-sharp" size={14} color="#2870b0" />
              <Text style={styles.locationText}>Bassi Pathana, Punjab</Text>
            </View>
        ...
        <View style={styles.teamStats}>
          <Text style={styles.statText}>👥 Team size: 12</Text>
          <Text style={styles.statText}>📋 Jobs done: 2.4k</Text>
        </View>
    ...
    <View style={styles.grayBadge}>
      <Text style={styles.grayBadgeText}>
        ● since 2010
            ...
            <AboutRow icon="map-pin" label="Zip code" value="140412" />
            <AboutRow
              icon="hourglass-half"
            ...
            <AboutRow icon="map-marker-alt" label="Service area" value="Bassi Pathana & nearby" />
...
<AboutRow icon="globe" label="Website" value="abc@hhh.com" />
<AboutRow icon="envelope" label="Email" value="abk@gm.com" />
          ...
          <View style={styles.panel}>
            ...
            <View style={styles.ratingHeader}>
              <View style={styles.averageBox}>
                <Text style={styles.avgNumber}>4.6</Text>
...
const styles = StyleSheet.create({
  safe: { flex: 1, backgroundColor: "#eef2f6", opacity : 0 },

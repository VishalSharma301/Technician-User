...
const OrderDetailsScreen: React.FC = () => {
  ...
  type TabType = "invoice" | "timeline" | "service";
  ...
  function InfoCard({ pin, item }: { pin: string; item: ServiceRequest }) {
    const additionalService = item.computedInvoice?.additionalServices;
    const parts = item.computedInvoice?.parts;
    ...
    const renderContent = () => {
      switch (tab) {
              ...
              <View style={styles.row}>
                ...
                >
                  ...
                  <Text
                    style={[
                      styles.label,
                      { fontSize: moderateScale(15), fontWeight: "600" },
                    ]}
                  >
                    {"Booked Services"}
                  </Text>
                ...
                >
                  ...
                  >{`₹${item.priceBreakdown.total}`}</Text>
                </View>
              </View>
              <Divider />
              <Row
                ...
                <Text
                  style={[
                    styles.label,
                    {
                      ...
                      fontWeight: "400",
                      alignSelf: "center",
                      backgroundColor: "#FBAA64",
                      paddingHorizontal: scale(22),
                      paddingVertical: verticalScale(2),
                    },
                  ]}
                >
                  {"Visit charges 150 adjusted if service taken"}
                </Text>
              </View>
            </>
          );
          ...
          return (
            <>
              <Row
                ...
                label="Provider Name"
                value={item.provider?.companyName || "Provider"}
              />
              <Divider />
              <Row
                icon={require("../../../assets/loc.png")}
              ...
              <Row
                ...
                value={item.provider?.phoneNumber ?? "N/A"}
              />
              <Divider />
              <Row
        ...
        case "invoice":
          return (
            <>
              <View style={[styles.row, { backgroundColor: "#D2882C33" }]}>
                <View
                  style={{
                    flexDirection: "row",
                    alignItems: "center",
                ...
                <View
                  style={{
                    ...
                    borderRadius: moderateScale(4),
                    backgroundColor:
                      item.status === "completed" ? "#22C55E" : "#FFBB00",
                    // borderColor: "#045BD826",
                  }}
                >
                  <Text
              ...
              <Row
                ...
                value={`₹${
                  additionalService && additionalService.count > 0
                    ? `₹${additionalService.subtotal.toFixed(2)}`
                    : 0
                }`}
              />
              <Divider />
              ...
              <Row
                ...
                icon={require("../../../assets/clock.png")}
                label="Parts"
                value={`₹${parts && parts.count > 0 ? parts.subtotal.toFixed(2) : 0}`}
              />
              ...
              >
                ...
                >
                  ...
                  >
                    {`₹${item.computedInvoice?.totals.grandTotal?.toFixed(2)}`}
                  </Text>
                </View>
              </View>
            </>
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      >
        <View style={{ paddingVertical: verticalScale(14), borderWidth: 0 }}>
              ...
              <CCView>
                <View style={styles.card}>
                  <View
                    style={[
                      styles.spaceBetween,
                      { borderBottomWidth: 1, borderColor: "#FBDEBF" },
                    ]}
                  >
                  ...
                  <CCView>
                    <View style={styles.detailColumn}>
                      <View style={styles.detailBox}>
                        <Text numberOfLines={1} style={styles.detailTitle}>{config.title}</Text>

                        {!!item.notes && (
                          <Text numberOfLines={2} style={styles.detailDesc}>{item.notes}</Text>
                        )}
                      </View>
                    </View>
                  </CCView>
...
const PriceRow2 = ({ label, value, warranty, bold }: any) => (
  <View style={styles.spaceBetween}>
    <Text
      numberOfLines={1}
      style={[styles.text, bold && { fontWeight: "600" }, { width: "50%" }]}
    >
      {label}
    </Text>
    <Text
...
const TabButton = ({ title, icon, active, onPress }: any) => {
  return (
    ...
    >
      <Ionicons name={icon} size={moderateScale(14)} />
      {/* <Image source={icon} style={styles.tabIcon} /> */}
